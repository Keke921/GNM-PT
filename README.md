...
Schematic of the parameter update in GNM and SAM. $\boldsymbol{\theta}^{GNM}_{t+1}$ represent the gradient update with original SGD, with SAM and with GNM for step $t+1$, respectively.
